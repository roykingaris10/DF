return function(Client)
	...
	FXClient.AerialIndicator = function(self: {any}, Args: {any}, ServerCall: boolean?)
...
--		SoundHandler.Spawn('Combat/CritIndicator', self.Character.Root, 1);
		...
		Highlight.OutlineColor = Color3.fromRGB(20, 255, 216)
	...
	FXClient.Aerial = function(self: {any}, Args: {any}, ServerCall: boolean?)
	--	if ServerCall and self.IsClient then return end;
		local Enabled = Args[1]
		local RootCFr = self.Character.Root.CFrame;
