...
function LightningBolt.new(Attachment0, Attachment1, PartCount, HighlightProperties: {any}?)
	...
	branchModel.Name = "LightningBranch"
	branchModel.Parent = workspace.EffectsFolder
	...
	if HighlightProperties then
		local highlight = Kits.Storage.Highlight:Clone()
		highlight.FillTransparency = HighlightProperties.FillTransparency or 1
		highlight.FillColor = HighlightProperties.FillColor or Color3.fromRGB(0, 0, 0)
		highlight.OutlineColor = HighlightProperties.OutlineColor or Color3.fromRGB(255, 255, 255)
		highlight.FillTransparency = HighlightProperties.FillTransparency or 0
		highlight.OutlineTransparency = HighlightProperties.OuttlineTransparency or 1
		highlight.DepthMode = HighlightProperties.DepthMode or Enum.HighlightDepthMode.Occluded
		highlight.Enabled = true
		highlight.Adornee = branchModel
		highlight.Parent = branchModel
