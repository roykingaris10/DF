...
QuestInfo.BanditBeater = {
	...
	Caption = "The outskirts breathe a little easier tonight.",
	Category = "Normal",
	Giver = "Soren",
	TurnInTo = "Soren",
...
QuestInfo.SpecialDelivery = {
	...
	Caption = "Some cargo only travels safely by hand.",
	Category = "Normal",
	Giver = "Quartermaster",
	TurnInTo = "Dockmaster",
...
QuestInfo.MarineTrial = {
	...
	Caption = "The white coat is heavier than it looks.",
	Category = "Faction",
	Giver = "MarineCaptain",
...
QuestInfo.WantedBounty = {
	...
	Caption = "Another name crossed off the wall.",
	Category = "Special",
	Giver = "BountyBoard",
...
QuestInfo.CrewRaid = {
	...
	Caption = "A crew worth its salt fights as one.",
	Category = "Crew",
...
QuestInfo.DummyTraining = {
	...
	Caption = "Sharper than yesterday. Not yet sharp enough.",
	Category = "Normal",
	Giver = "TrainerSign",
...
QuestInfo.SpeedRun = {
	...
	Caption = "The wind couldn't keep up.",
	Category = "Special",
	Giver = "Wanderer",
	TurnInTo = "Wanderer",
...
QuestInfo.SnackRun = {
	...
	Caption = "A full belly is half the battle.",
	Category = "Normal",
	Giver = "Cook",
	TurnInTo = "Cook",
...
QuestInfo.LogueTownVisit = {
	...
	Caption = "Where every legend takes its first or final breath.",
	Category = "Normal",
	Giver = "Wanderer",
	TurnInTo = "Wanderer",
...
QuestInfo.BoundaryHunter = {
	...
	Caption = "Steel, distance, and a spoken word — a hunter is forged from all three.",
	Category = "Normal",
	Giver = "TrialMaster",
