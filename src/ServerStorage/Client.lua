...
local Startingtable = {script.CharSetup.CharacterHandler,script.CharSetup.Inputter,script.ClientNetwork.ClientNetwork,
	...
	script.ClientModules.CompassController, script.ClientModules.NotificationController, script.ClientModules.DeathClient, script.ClientModules.QuestCompleteController, script.ClientModules.QuestClient, script.ClientModules.DevFakePlayers, script.ClientModules.TopbarIcons}
